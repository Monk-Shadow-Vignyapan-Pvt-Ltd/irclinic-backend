...
import { addStockin, getStockins,getAllStockins, getStockinById,getStockinsByInventoryId, deleteStockin,updateStockin,dashboardStockins, searchStockins} from "../controllers/stockin.controller.js";
...
router.route("/getAllStockins").get( getAllStockins);
...
router.route("/searchStockins").post( searchStockins);
