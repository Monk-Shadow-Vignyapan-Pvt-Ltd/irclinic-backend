...
import { addActivity, getActivities, getActivityById, deleteActivity, updateActivity ,followupActivity, dashboardActivities,searchActivities} from "../controllers/activity.controller.js";
...
router.route("/followupActivity/:id").put( followupActivity);
