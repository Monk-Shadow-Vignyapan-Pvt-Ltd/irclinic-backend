...
import { addDoctor, getDoctors,getAllDoctors,getAllDoctorsByCenterId,getReferenceDoctors,
...
router.route("/getAllDoctorsByCenterId/:id").get(getAllDoctorsByCenterId);
